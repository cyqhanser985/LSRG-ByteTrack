...
依据《../docs/研究方向.md》执行的"小型可观测性诊断实验"独立工作区：在冻结 switch 事件池（S_c 1,841 / S_r 1,921 / S_h 994，共 4,756）上验证四个廉价正交门控信号（Margin / Motion Surprise / Occlusion / Swap Instability）的联合识别率（分类别 + 全部），裁决 Gate 路线去留。
...
| `../reports/day3_report.md` | 最终报告：协议、四特征诊断、召回率表、并集分解、Go/No-Go 判定 |
